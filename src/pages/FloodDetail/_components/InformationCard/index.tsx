...
export const InformationCard: FC<Props> = ({ deviceData }) => {
          ...
          <div className="flex flex-col gap-3 rounded-lg">
            {deviceData?.sensorlog?.data?.map((sensor, index) => {
              ...
              return (
                <div
                  key={index}
                  className="flex w-full justify-between gap-2 rounded-lg border border-rs-v2-thunder-blue bg-rs-v2-thunder-blue px-3.5 py-3"
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <p className="text-sm font-medium text-rs-neutral-dark-platinum">
                      |
                    </p>
                    <ElapsedTime
...
const ElapsedTime = ({
  ...
  if (!alertStart)
    return <p className="w-[38px] font-semibold text-white">-</p>;
