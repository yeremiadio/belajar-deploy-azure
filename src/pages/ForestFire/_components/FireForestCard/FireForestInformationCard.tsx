...
import { useConfirmNotificationMutation } from '@/stores/ewsStore/ewsForestFireStoreApi';
import { ErrorMessageBackendDataShape } from '@/types/api';
import { ESensorForestFireEnum } from '@/types/api/ews/ewsForestFire';
import { EStatusAlertEnum, TGatewayDevice, TSensorData } from '@/types/api/socket';
...
type Props = {
  ...
  setSelectedSensor: (e: keyof typeof ESensorForestFireEnum) => void;
  selectedSensor: keyof typeof ESensorForestFireEnum;
};

export const FireForestInformationCard: FC<Props> = ({
  device,
  setSelectedSensor,
  selectedSensor,
}) => {
    ...
    <div className="flex flex-col gap-2">
      ...
      !userAlreadyConfirmed ? (
        <button
          ...
          onClick={(e) => {
            e.stopPropagation();
            const sensorWithAlert: TSensorData[] = sensorlog.data.filter(
