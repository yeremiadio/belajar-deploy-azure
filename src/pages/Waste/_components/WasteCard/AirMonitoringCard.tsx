...
import { SensorInformationCard } from '@/pages/Waste/_components/InformationCard';
import AirMonitoringChartCard from '@/pages/Waste/_components/WasteChart/AirMonitoringChart';
...
const AirMonitoringCard: FC<Props> = () => {
            ...
            <div className="px-5 py-3">
              {deviceList?.map((item) => {
                return item.sensorlog ? (
                  <SensorInformationCard key={item.id} devices={item} />
                ) : (
...
export default AirMonitoringCard;
