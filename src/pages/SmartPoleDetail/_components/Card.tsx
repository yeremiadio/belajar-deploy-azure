...
export const Card: FC<Props & HTMLAttributes<HTMLDivElement>> = ({
  ...
  return (
    <div
      className={cn(
        `box-border overflow-hidden p-6 rounded-xl flex flex-col h-[300px] xl:h-auto`,
        border ? "border-2 border-rs-v2-thunder-blue bg-rs-v2-navy-blue" : "",
        className
      )}
      {...rest}
    >
      <h1 className="text-lg md:text-xl 2xl:text-2xl font-medium text-rs-neutral-silver-lining">
