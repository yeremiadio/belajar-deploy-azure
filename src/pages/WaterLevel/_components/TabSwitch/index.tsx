...
const TabSwitch: FC<Props> = ({ handleViewChange, viewParameter }) => {
  return (
    <div className="inline-flex items-center gap-3 col-span-3">
      <div>
        <div className="flex bg-rs-v2-navy-blue border-rs-v2-thunder-blue rounded-md text-[13px] text-rs-v2-light-grey">
          <button
            type="button"
            className={cn(
              'min-w-[60px] rounded-l-md p-3 hover:bg-rs-v2-dark-grey hover:text-rs-v2-mint',
              viewParameter === 'DAY' &&
          ...
          <button
            type="button"
            className={cn(
              'min-w-[60px] rounded-r-md p-3 hover:bg-rs-v2-dark-grey hover:text-rs-v2-mint',
              viewParameter === 'MONTH' &&
                'bg-rs-v2-dark-grey text-rs-v2-mint',
            )}
